...
public class Notice extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View view =  inflater.inflate(R.layout.fragment_notice, container, false);
        ...
        progressBar = view.findViewById(R.id.noticepb);


        WebView webView = view.findViewById(R.id.noticeweb);
        ...
        webView.loadUrl("https://www.bujhansi.ac.in/en/news?Newslistslug=en-notice-and-announcements");
