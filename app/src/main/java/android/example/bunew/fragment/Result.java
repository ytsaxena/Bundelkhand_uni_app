...
public class Result extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = view.findViewById(R.id.resultpb);

        WebView webView = view.findViewById(R.id.resultweb);
        ...
        webView.loadUrl("https://exam.bujhansi.ac.in/frmViewCampusCurrentResult.aspx?cd=MwA3ADkA");
